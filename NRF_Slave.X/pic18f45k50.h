#ifndef PIC18F45K50_H
#define	PIC18F45K50_H
...
/**
 * Setup Device (IO pins, Oscillator and etc)
 */
void device_setup();

/**
 * Setup UART for the desired baudrate
 * @param uint32_t baudrate : Desired baudrate for the UART
 */
